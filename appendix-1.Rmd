...
```{r options-appendix, warning=FALSE, include=FALSE}
...
# Confirming the five factor solution obtained using minimum residual extraction method
...
```{r corunm, fig.cap="Correlation plot of the items [Unmerged response options]",  out.width="100%"}
...
```{r Timezone-tab, include=FALSE, warning=F,message=FALSE}
descriptives.data%>%
  tbl_summary(
