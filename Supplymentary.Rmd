...
```{r facIdFigAppB, fig.align='center', fig.cap='Factor Identification (A) Parallel analysis (B) Scree Plot', warning=FALSE}
...
apa_table(efa.table,align = "c", caption = "Factor loadings and communality of the retained items [Unmerged Responses]", note = "Only loading higher than .30 is reported", font_size = "small", longtable =T)
```
...
```{r EFAResidualsAppB,  fig.align='center', fig.cap=' Histogram of residulas:  five-factor solution', warning=FALSE,  results='asis'}
