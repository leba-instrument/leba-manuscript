...
\caption{\label{tab:AtabDes}Descriptive Statistics for Unmerged response options}
...
{\centering \includegraphics[width=1\linewidth,height=2\textheight]{manuscript_files/figure-latex/AfacIdFig-1} 

}

\caption{Factor Identification (A) Parallel analysis (B) Scree Plot}(\#fig:AfacIdFig)
\end{figure}
...
solution. five-factor solution (Figure@ref:AfacIdFig). As a result, we
tested both five-factor and six-factor solutions.
...
\caption{\label{tab:AEFATable}Factor loadings and communality of the retained items [Unmerged Responses]}
