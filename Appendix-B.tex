...
\caption{\label{tab:tabDesAppB-30}Descriptive Statistics for Unmerged response options}
...
{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/figCorAppB-32-1} 

}

\caption{Correlation plot of the items}(\#fig:figCorAppB-32)
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth,height=1\textheight]{manuscript_files/figure-latex/facIdFigAppB-36-1} 

}

\caption{Factor Identification (A) Parallel analysis (B) Scree Plot}(\#fig:facIdFigAppB-36)
\end{figure}
...
\caption{\label{tab:EFATableAppB-39}Factor loadings and communality of the retained items [Unmerged Responses]}
...
{\centering \includegraphics[width=0.5\linewidth,height=0.5\textheight]{manuscript_files/figure-latex/EFAResidualsAppB-40-1} 

}

\caption{ Histogram of residulas:  five-factor solution}(\#fig:EFAResidualsAppB-40)
\end{figure}
\end{appendix}
