...
\begin{figure}
\includegraphics[width=1.2\linewidth,height=1\textheight]{Manuscript.figures/gt} \caption{ Summary Descriptives of CFA and EFA Sample}\label{fig:gtPic}
\end{figure}
