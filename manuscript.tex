...
\begin{tabular}{lllll}
\toprule
Name & Author & Description & Relevant Items & Adaptations\\
\midrule
Visual Light Sensitivity Questionnaire-8 & {}[@verriotto2017new] & Eight-question survey to assess the presence and severity of photosensitivity symptoms & NA & NA\\
Office Light Survey & {}[@eklund1996development] & Multi-item questionnaire to assess electrical lighting environment in office & NA & NA\\
Harvard Light Exposure Assessment Questionnaire & {}[@bajaj2011validation] & Self-administered semi-quantitative light questionnaire & NA & NA\\
Hospital Lighting Survey & {}[@dianat2013objective] & 23 items questionnaire to assess light environment in a hospital & NA & NA\\
Morningness-Eveningness Questionnaire & {}[@horne1976self] & 19 items questionnaire to understand your body clock & NA & NA\\
\addlinespace
Munich Chronotype Questionnaire (MCTQ) & {}[@roenneberg2003life] & 17 items questionnaire to understand individuals phase of entrainment & NA & NA\\
Assessment of Sleep Environment & {}[@Olivier.2016] | 13 & items questionnaire measuring your sleep environment quality & NA & NA\\
The Pittsburgh Sleep Quality Index (PSQI) & {}[@buysse1989pittsburgh] & 9 items inventory to measure sleep quality and sleeping pattern & NA & NA\\
Self-Rating of Biological Rhythm Disorder for Adolescents (SBRDA) & {}[@Xie.2021] | 29 & items questionnaire assessing four dimensions of biological rhythm disorder in adolescents (digital media use, sleep, eating habits, and activity) & Item 3,22-25 and 29 & NA\\
Photosensitivity Assessment Questionnaire (PAQ) & {}[@Wu.2017] | 16 & dichotomous (yes/no) items questionnaire to assess "photophobia" and "photophilia", giving two final scores of "photophobic" and "photophilic" behaviours & All itms & NA\\
\bottomrule
\end{tabular}
...
\caption{\label{tab:tabDesAppB-39}Descriptive Statistics for Unmerged response options}
...
{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/figCorAppB-41-1} 
...
{\centering \includegraphics{manuscript_files/figure-latex/facIdFigAppB-45-1} 
...
{\centering \includegraphics{manuscript_files/figure-latex/EFAResidualsAppB-49-1} 
