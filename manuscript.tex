...
\caption{\label{tab:prepareDescTable}Demographics}
\centering
\resizebox{\linewidth}{!}{
...
{\centering \includegraphics[width=2\linewidth,height=1\textheight]{Manuscript.figures/EFAplot} 
...
\hypertarget{sementic-analysis}{%
\subsection{Sementic Analysis}\label{sementic-analysis}}

To find out if our developed scale is overlapping with existing instruments, we subjected the items of LEBA to The ``Semantic Scale Network''(SSN)(Rosenbusch, Wanders, \& Pit, 2020). The SSN detects semantically related scales and provides cosine similarity index ranging between -.66 to 1 (Rosenbusch et al., 2020). Pairs of scale with a cosine similarity index value of 1 indicates they are perfectly redundant scales. LEBA appeared most strongly related to scales about sleep: ``Sleep Disturbance Scale For Children'' (Bruni et al., 1996) and ``WHO-Composite International Diagnostic Interview (CIDI): Insomnia''(WHO, 1990).The cosine similarities lie between .47 to .51. Two factors of our LEBA tool: ``Using phone and smart-watch in bed'' and ``Using light before bedtime'' dealt with light exposure related behavior pertaining to sleep quality. As such the similarity index obtained is expected.
...
\begin{figure}
\includegraphics[width=1\linewidth,height=1.2\textheight]{manuscript_files/figure-latex/personfit-1} \caption{Person fit of the five fitted IRT models (a) Wearing blue light filters (b) Spending time outdoors (c) Using phone and smartwatchin bed (d) Using light before bedtime (e) Using light in the morning andduring daytime}\label{fig:personfit}
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-R-ufs}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-who1990}{}}%
