...
```{r MinVar, eval=FALSE, include=FALSE}
# ScreePlot with minimum variance explained, message=FALSE, warning=FALSE}
library(FactoMineR)
library(factoextra)
#PCA graph of variables
pca = PCA(EFA.data)
#Component ploted against percentage of explained variables
