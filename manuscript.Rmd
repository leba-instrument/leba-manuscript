...
ggsave("Manuscript.figures/EFAfull.png",EFAplot.1, width = 4, height =8, dpi = 1200, bg ="white")

```

```{r EFAplot, fig.align='center', fig.cap='(A) Five Factor Solution obtained in Exploratory Factor Analysis. The factor loadings ranged between .49-.99 (B) Histogram of nonredundent residula correlations indicated 26% correlations are higher than absolute value of .05 indicating a possible under factoring', warning=FALSE,  results='asis'}
...
```{r figcfa, fig.cap = "Five Factor  Model of LEBA obtained by Confirmatory Factor Analysis. By allowing item pain 41 & 30 to covary their error variance our model attained the best fit.", out.height="150%", out.width="100%", dpi=1200,  warning=FALSE}
#library(semPlot)
...
ggsave("Figures/ICC2.jpeg",ICC2 , width = 12, height = 8, dpi = 1200, bg = "white")
