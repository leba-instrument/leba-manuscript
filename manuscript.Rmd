...
pacman::p_load(MOTE, tidyverse, psych, lavaan,kableExtra,gt,gtsummary, mirt,likert,kutils,semPlot,semTable,semTools,ggcorrplot,dlookr,qgraph,paran,EFA.MRFA,VIM,DiagrammeR,DiagrammeRsvg,ggplot2,cowplot,rsvg,questionr,magick, simsem,readxl, stringr,RColorBrewer,WrightMap,huxtable)
...
Flowchart1 <- grViz("digraph nicegraph{
                    ...
                    C[label = 
                    <
                    Factor Identification<br align = 'center'/>
                    Scree Plot: 6 Factors<br align = 'center'/>
                    Parallel Analysis: 6 Factors<br align = 'center'/>
                    Minimum Average Partial Method: 5 Factors<br align = 'center'/>
                    Hull Method: 5 Factors<br align = 'center'/>
                    >
                    ]
                ...
                fixedsize = true, fontsize = 45 ]
                    6[label = 
                    <
                    6-Factor solution:<br align = 'center'/> 
                    one factor emerged with only two salient loadings
                    >
                    ]
                    7[label = 'Rejected']
                    }     
...
```{r iteminfo, eval=FALSE, warning=FALSE, include=FALSE}
