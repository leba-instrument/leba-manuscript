...
# add coloured dots and lines on the first column
  ...
  group = "EFA (n = 428)",
    rows = 1:25  
  ) %>% gtsave("Manuscript.figures/gt.png",vwidth = 3000)


```

```{r gtPic, echo=FALSE, out.height="100%", out.width="120%", fig.cap= ' Summary Descriptives of CFA and EFA Sample'}
