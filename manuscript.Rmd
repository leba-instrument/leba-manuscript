...
F2_iteminfo <- plot(F2_fit, type = "infotrace", facet_items = T, main = NULL)
...
F4_iteminfo <- plot(F4_fit, type = "infotrace", facet_items = T,main = NULL)
...
F5_iteminfo <- plot(F5_fit, type = "infotrace", facet_items = T,main = NULL)
...
```{r Iteminformationcurve, fig.cap="Item information curves (A) blue filter (B) natural light (C)smart device (D)sleep environment (E)electic light", warning=FALSE, out.width="120%", out.height="150%"}
