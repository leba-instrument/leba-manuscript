...
We also analysed possible semantic overlap of our developed tool using "Semantic Scale Network" enginee [@rosenbusch2020semantic].  Lastly, we sought "Item Response Theory" (IRT) based analysis on developing a short form of LEBA.
