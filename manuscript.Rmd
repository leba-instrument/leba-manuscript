...
Scree plot ( Figure \@ref(fig:efa-plot) B) suggested a six-factor solution. However, the minimum average partial (MAP) [@velicerDeterminingNumberComponents1976] method (Supplementary Table 2) and Hull method [@lorenzo-sevaHullMethodSelecting2011] ( Figure \@ref(fig:efa-plot-print) D) suggested a five-factor solution. As a result, we tested both five-factor and six-factor solutions.
