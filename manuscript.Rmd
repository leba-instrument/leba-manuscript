...
Participants indicated filling out the online survey from a diverse range of geographic locations. The ten most common country and time zone combinations included:

```{r fig.cap="Countries with Highest Responses", out.height= '100%', out.width= '100%'}
...
For a complete list of geographic locations, see Suppl. Table \@ref(tab:tztable).
