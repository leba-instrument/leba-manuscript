...
```{r CFA21}
LB.model.Cor.3 <- "F1 =~ a1*item16 + item36 + a2*item17
                 F2 =~ item11 + item10 + item12+ item7+ Ritem8+ item9
                 F3 =~  item27+ item3+ item40 
                 F4 =~ a3*item32 + item35 + item38+ a4*item33 
                 F5 =~ item46+ item45+ item25+ item4+ item1 
                       a1==a2
                       a3==a4
...
#item30 & 41 are removed

## Fit the model 
fit.Cor.3 <- cfa(LB.model.Cor.3, data = CFA.data, ordered = names(CFA.data),estimator = "WLSMV") 

rel.k.1 <- semTools::reliability(fit.Cor.3, return.total = T)
## Summary of Model 
cfa.sum.3 <- summary(fit.Cor.3, fit.measures =TRUE,standardized = TRUE, rsq =TRUE)
...
## Fit the model 
fit.Cor.4 <- cfa(LB.model.Cor.4, data = CFA.data, ordered = names(CFA.data),estimator = "WLSMV") 

rel.k.4 <- semTools::reliability(fit.Cor.4, return.total = T)
## Summary of Model 
cfa.sum.4 <- summary(fit.Cor.4, fit.measures =TRUE,standardized = TRUE, rsq =TRUE)
