...
+=================================================+=========+========================================================================================+:==============:+=============+
| Visual Light Sensitivity Questionnaire-8        | a       | Eight-question survey to assess the presence and severity of photosensitivity symptoms | all            | jhghjgjhgfd |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| Office Light Survey                             | b       | Multi-item questionnaire to assess electrical lighting environment in office           | aa             | gh          |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| Harvard Light Exposure Assessment Questionnaire | c       | Self-administered semiquantitative light qestionnaire                                  | aa             | as          |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| Hospital Lighting Survey                        | d       | 23 items questionnaire to assess light environment in a hospital                       | dd             | fg          |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| Morningness-Eveningness Questionnaire           | e       | 19 items questionnaire to understand your body clock                                   | ff             | hj          |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| Munich Chronotype Questionnaire (MCTQ)          | f       | 17 items questionnaire to understand individuals phase of entrainment                  | ff             | jk          |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| Assessment of Sleep Environment                 | g       | 13 items questionnaire measuring your sleep environment quality                        | ff             | kl          |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
| The Pittsburgh Sleep Quality Index (PSQI)       | h       | 9 items inventory to measure sleep quality and sleeping pattern                        | ff             | klfrgfgvfg  |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
|                                                 |         |                                                                                        |                |             |
+-------------------------------------------------+---------+----------------------------------------------------------------------------------------+----------------+-------------+
|                                                 |         |                                                                                        |                |             |
...
```{r facIdFig, out.height="100%", out.width="200%",fig.align='center', fig.cap='Factor Identification (A) Parallel analysis (B) Scree Plot (C) Hull Method',  warning=FALSE}
...
F2_info.redu <- plot(F2_fit.redu, type = "infoSE", main = "F2")


F3_info.redu <- plot(F3_fit.redu, type = "infoSE", main = "F3")

F4_info.redu <- plot(F4_fit.redu, type = "infoSE", main = "F4")
...
plot_grid(F1_info, F2_info.redu,F3_info.redu,F4_info.redu,F5_info, 
          labels = c('A', 'B','C', 'D', 'E' ), label_size = 10)
