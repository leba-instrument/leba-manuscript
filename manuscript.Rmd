...
```{r EFAplotcode, eval=FALSE, include=FALSE}
...
efa.tab.ful <- cbind(efa.table[,1],efa.stems, efa.table[,2:8] )
...
apa_table(efa.tab.ful, caption = "Factor loadings and communality of the retained items", note = "Only loading > .30 is reported", 
...
Supplementary Table S3 summarizes the item fit indexes of the 18 items. All of the items had RMSEA value $\le$.06 indicating adequate fit of the items to the fitted IRT model. Sup.Figure \@ref(fig:personfit) depicts the person fit Zh statistics histogram of out fitted models. Zh statistics are larger than -2 for most participants, suggesting a good person fit of the selected IRT models. 
