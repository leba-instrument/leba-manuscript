...
```{r scalechar, fig.cap="Scale characteristic curve of the five fitted IRT models (a) Blue filter (b) Natural light (c)Smart device (d)Sleep environment (e)Electic light", warning=FALSE, out.width="100%", out.height="120%"}
