...
as_kable_extra(desc_table, format = "latex",booktabs = T) %>% 
  kable(col.names=c("Variable", "Overall, n=690$^{1}$","EFA Sample, n=428$^{1}$", "CFA sample, n=262$^{1}$", "p", "q$^{2}$"), escape = FALSE)-> desc_kable #save it as a knitr::kable
...
```{r partmap, eval=FALSE, fig.cap="Top ten countries with highest responses in our survey", include=FALSE, out.height='100%', out.width=}
