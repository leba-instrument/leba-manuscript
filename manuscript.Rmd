...
Figure \@ref(fig:efagtPic1) and Figure \@ref(fig:efagtPic2) summarize the response pattern of our total sample (n = `r nrow(sem.data)`) for all 48 items. Most of the items were skewed.
...
```{r efa-plot-print, fig.align= 'center', fig.cap='(ref:efa-plot-print)',  warning=FALSE, results= 'asis', out.height='90%', out.width='110%'}
...
## Secondary Analysis: Semantic Scale Network and Grade Level
