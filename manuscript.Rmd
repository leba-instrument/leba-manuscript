...
Flowchart1 <- grViz("digraph my_flowchart{
                    ...
                    K[label = 'Long LEBA: 23-item', style = filled, fillcolor = Beige]
                    ...
                    O[label = 'Short LEBA: 18-item',style = filled, fillcolor = Beige]
...
corplot <- ggcorrplot(correlations$rho, hc.order = TRUE, outline.col = "white", type = "lower", legend.title = "Correlation",
