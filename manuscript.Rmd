...
```{r efagtPic1, echo=FALSE,  fig.cap= 'Summary descriptives and response pattern', out.height='100%', out.width='250%'}
knitr::include_graphics('Figures/Figure2.png')

```

```{r efagtPic2, echo=FALSE,  fig.cap= 'Summary descriptives and response pattern', out.height='100%', out.width='250%'}
...
```{r efa-plot-print, fig.align= 'center', fig.cap='(ref:efa-plot-print)',  warning=FALSE, results= 'asis', out.height='100%', out.width='110%'}
