...
Flowchart1 <- grViz("digraph my_flowchart{
                    ...
                    10[label = <LEBA Short Form (19 Items; n=690)<br/>Based on Item Response Theory>]
                    }
                subgraph cluster_2 {
...
```{r partmap, fig.cap="Countries with Highest Responses", out.height= '100%', out.width= '100%'}
...
colnames(descriptives) <- c("Items", "Mean", "SD", "Skew", "Kurtosis", "SW Statistics", "Item-total corelation")
