...
ggsave("Manuscript.figures/corplot.png",corplot, width = 6, height = 6, dpi = 1200, bg ="white")
...
knitr::include_graphics('Manuscript.figures/corplot.png', dpi =1200)
...
ggsave("Manuscript.figures/factors.png",fator, width = 6, height = 12, dpi = 1200)
```
...
ggsave("Manuscript.figures/EFAfull.png",EFAplot.1, width = 10, height =10, dpi = 1200)
...
knitr::include_graphics('Manuscript.figures/EFAfull.png', dpi =1200)
```
...
knitr::include_graphics('Manuscript.figures/efagt.png',dpi =1200)

```

```{r cfagtPic, echo=FALSE, out.height="100%", out.width= '100%', fig.cap= ' Summary Descriptives of CFA Sample'}
knitr::include_graphics('Manuscript.figures/cfagt.png',dpi =1200)
...
```{r figcfa, fig.cap = "Five Factor CFA Model of LEBA", out.height="150%", out.width="100%", dpi=1200,  warning=FALSE}
#library(semPlot)
...
F2.itemplots <- cowplot::plot_grid(F2.iteminfo.1,F2.iteminfo.2, F2.iteminfo.3,
                   ...
                   labels = "AUTO",
                     ...
                     label_fontfamily = "serif",
                     label_fontface = "plain")
ggsave("Manuscript.figures/F2.itemplots.png",F2.itemplots, width = 10, height = 12, dpi = 1200, bg = "white")
...
F3.itemplots <- cowplot::plot_grid(F3.iteminfo.1,F3.iteminfo.2, F3.iteminfo.3,
                 ...
                 labels = "AUTO",
                     ...
                     label_fontfamily = "serif",
                     label_fontface = "plain")
ggsave("Manuscript.figures/F3.itemplots.png",F3.itemplots, width = 10, height = 12, dpi = 1200,bg = "white")
...
F4.itemplots <- cowplot::plot_grid(F4.iteminfo.1,F4.iteminfo.2, F4.iteminfo.3,
                   ...
                   labels = "AUTO",
                     ...
                     label_fontfamily = "serif",
                     label_fontface = "plain")
ggsave("Manuscript.figures/F4.itemplots.png",F4.itemplots, width = 10, height = 12, dpi = 1200,bg = "white")
...
F5.itemplots <- cowplot::plot_grid(F5.iteminfo.1,F5.iteminfo.2, F5.iteminfo.3,
                   ...
                   labels = "AUTO",
                     ...
                     label_fontfamily = "serif",
                     label_fontface = "plain")
ggsave("Manuscript.figures/F5.itemplots.png",F5.itemplots, width = 10, height = 12, dpi = 1200, bg = "white")
```
...
TIC <- cowplot::plot_grid(F1.tic,F2.tic, F3.tic,
                   ...
                   labels = "AUTO",
                     ...
                     label_fontfamily = "serif",
                     label_fontface = "plain")
ggsave("Manuscript.figures/TIC.png",TIC, width = 10, height = 12, dpi = 1200, bg = "white")
...
knitr::include_graphics('Manuscript.figures/TIC.png', dpi =1200)
```
...
ggsave("Manuscript.figures/personfit.png",personfit , width = 10, height = 12, dpi = 1200, bg = "white")
