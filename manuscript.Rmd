...
```{r figcfa, fig.cap = "Five Factor  Model of LEBA obtained by Confirmatory Factor Analysis. By allowing item pain 41 and 30 to covary their error variance our model attained the best fit.", out.height="150%", out.width="100%", dpi=1200,  warning=FALSE}
