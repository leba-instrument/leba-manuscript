...
```{r figcfa, fig.cap = "Five Factor  Model of LEBA obtained by Confirmatory Factor Analysis. By allowing item pair 41 and 30 to covary their error variance our model attained the best fit.", out.height="150%", out.width="100%", dpi=600,  warning=FALSE}
...
F3.tic <- ggplot(F3.test.data, aes(x=Theta, y=F3.T1)) +
  geom_line()+apatheme+
  labs(y="Test Information", title = "F3 Test Inforfamtion")+ylim(0,8)
...
F5.tic <- ggplot(F5.test.data, aes(x=Theta, y=F5.T1)) +
  geom_line()+apatheme+
  labs(y="Test Information", title = "F5 Test Inforfamtion") +ylim(0,8)
