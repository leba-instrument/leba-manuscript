...
apa_table(efa.tab.ful, caption = "Factor loadings and communality of the retained items in EFA using principal axis extraction method", note = "Only loading > .30 is reported", 
