...
export_svg(Flowchart1) %>%
  charToRaw() %>%
  rsvg() %>%
  png::writePNG("Figures/Flowchart1.jpeg", dpi = 600)
...
ggsave("Figures/distribution.png", distribution, width = 12, height = 6, dpi = 600, bg ="white")
...
knitr::include_graphics('Figures/Flowchart.png', dpi = 600 )
```
...
knitr::include_graphics('Figures/distribution.png', dpi = 300 )
```
...
# add coloured dots and lines on the first column
  ...
  cols_width(
    Stem ~ px(200)) %>% 
 gtsave("Figures/gt_full_p1.png", vwidth = 6000)
...
scree.plot <-ggplot(FA.Scree, aes(x=num, y=eigenvalue,color=type, shape=type))+
  ...
  scale_x_continuous(name="Factor Number", limits=c(0, 20),breaks=seq(0,20,4))+
  geom_hline(yintercept=1, linetype = 'dashed') + apatheme +theme(legend.position = "None") 
#text = element_text(size = 25
...
export_svg(EFAplot) %>%
  charToRaw() %>%
  rsvg() %>%
  png::writePNG("Figures/EFAplot.png",dpi =600)
...
# add coloured dots and lines on the first column
  ...
  gtsave("Supplimentary_materials/S_Figure/S2_Fig.png",vwidth = 7000)
...
TIC.plot <- cowplot::plot_grid(F1.tic,F2.tic, F3.tic,
                   ...
                   labels = "AUTO",
                     ...
                     label_fontfamily = "Arial",
                     label_fontface = "plain")
ggsave("Figures/TIC.png",TIC.plot, width = 18, height = 12, dpi = 600, bg = "white")
...
ggsave("Figures/personfit.png",personfit , width = 10, height = 12, dpi = 600, bg = "white")
