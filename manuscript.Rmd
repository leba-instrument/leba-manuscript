...
IRT.descriptives <- descriptives.data
...
IRT.descriptives# Total sample, n = 690
...
LB.model.Cor.1 <- "F1 =~ item16 + item36 + item17
                 F2 =~ item11 + item10 + item12+ item7+ Ritem8+ item9
                 F3 =~  item27+ item3+ item40 + item30 + item41
                 F4 =~ a1*item32 +item35 + Ritem37 + item38+ a2*item33 
                 F5 =~ item46+ item45+ item25+ item4+ item1+ Ritem26
...
## Summary of Model 
summary(fit.Cor.1, fit.measures =TRUE,standardized = TRUE)
...
semTools::reliability(fit.Cor.1)
...
LB.model.Cor.2 <- "F1 =~ item16 + item36 + item17
                 F2 =~ item11 + item10 + item12+ item7+ Ritem8+ item9
                 F3 =~  item27+ item3+ item40 + item30 + item41
