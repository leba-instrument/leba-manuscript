...
apa_table(Invariance.table, align = "c",  caption = "Measurment Invariance analysis on CFA sampe (n=262) across native and non-native English speakers.", note = " a = Metric vs Configural; b = Scalar vs Metric; c = Residual vs Scalar; d = Structural vs Residual;* =  df of model comparison", landscape = T, font_size = "footnotesize" )
...
apa_table(itemparameters, caption = "Items discrimination and tesponse category thresholds of  LEBA with 23 items (n =690)", note = "a = item discrimination parameter; b(1-4) = response category difficulty parameter")
```
...
apa_table(IRT.details , caption ="Item discrimination, response category difficulty thrsholds and fit statistics of the short LEBA with 18 items (n=690)",note = "a = item discrimination parameter; b(1-4) = response category difficulty parameter")
```
