...
After reviewing the literature, we identified several light exposure related scale. However, no scales specifically measuring the behavioural component of light exposure were found (**Supplementary Table 1**). As such, all authors in collaboration of an expert panel developed a comprehensive item pool of 48 items. The expert panel composed of all authors and researchers from the fields of chronobiology, light research, neuroscience and psychology. The 48 items were then judged  based on their relevance and representativeness of the construct "Light Exposure Related Behaviour" by the expert panel. The panel members independently judged each of the items in terms of their relevance and representativeness and suggested required modification, if there is any. The author team acknowledged the suggestions and amended the items as required thus creating a 48-item scale.
...
ggsave("Supplimentary_materials/S_Figure/S3_Fig.png",all.factot.itemplots, width = 18, height = 12, dpi = 600, bg = "white")
...
**Supplementary Table 6** summarizes the item fit indexes of the 18 items. All of the items had RMSEA value $\le$.06 indicating adequate fit of the items to the fitted IRT model. **Supplementary Figure 4** depicts the person fit Zh statistics histogram of out fitted models. Zh statistics are larger than -2 for most participants, suggesting a good person fit of the selected IRT models. 
...
ggsave("Supplimentary_materials/S_Figure/S4_Fig.png",personfit , width = 10, height = 12, dpi = 600, bg = "white")
