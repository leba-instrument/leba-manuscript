...
\begin{figure}
\includegraphics[width=1\linewidth]{manuscript_files/figure-latex/figCorAppB-1} \caption{Correlation plot of the items}(\#fig:figCorAppB)
\end{figure}
...
\caption{(\#fig:EFAResidualsAppB) Histogram of residulas: five-factor
solution}
\end{figure}
\end{appendix}
