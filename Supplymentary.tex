...
\caption{\label{tab:MinResTab-31}Factor loadings and communality of the retained items(Minmum Residual)}
...
\caption{\label{tab:sixFacTab-33}Factor loadings and communality of the retained items(six factor)}
...
\caption{\label{tab:tabDesAppB-37}Descriptive Statistics for Unmerged response options}
...
{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/figCorAppB-39-1} 

}

\caption{Correlation plot of the items}(\#fig:figCorAppB-39)
\end{figure}

\begin{figure}

{\centering \includegraphics{manuscript_files/figure-latex/facIdFigAppB-43-1} 

}

\caption{Factor Identification (A) Parallel analysis (B) Scree Plot}(\#fig:facIdFigAppB-43)
\end{figure}
...
\caption{\label{tab:EFATableAppB-46}Factor loadings and communality of the retained items [Unmerged Responses]}
...
{\centering \includegraphics{manuscript_files/figure-latex/EFAResidualsAppB-47-1} 

}

\caption{ Histogram of residulas:  five-factor solution}(\#fig:EFAResidualsAppB-47)
\end{figure}
\end{appendix}
