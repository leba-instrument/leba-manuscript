...
```{r facIdFigAppB, eval=FALSE, fig.align='center', fig.cap='Factor Identification (A) Parallel analysis (B) Scree Plot', warning=FALSE, include=FALSE, out.height="100%", out.width="100%"}
...
```{r EFAResidualsAppB, echo=FALSE, fig.align='center', fig.cap=' Histogram of residulas:  five-factor solution', warning=FALSE, out.height="50%", out.width="50%", results='asis'}
