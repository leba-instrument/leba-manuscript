...
abstract: |
  ...
  The psychometric properties of the LEBA instrument indicate the usability to measure light exposure-related behaviours. The instrument may offer a scalable solution to characterize behaviours that influence individual photic exposure patterns in remote samples. The LEBA instrument will be available under the open-access CC-BY-NC-ND license.
