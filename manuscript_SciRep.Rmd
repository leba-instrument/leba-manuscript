...
On the other hand, several attempts have been made to quantify received light exposure subjectively with self-report questionnaires (**Supplementary Table 1**), bypassing the cost and intrusiveness issues. However, self-reporting light properties could be challenging for people who lack technical knowledge of light sources. Moreover, individuals may need to consider that, unlike a photometer, the human visual system continuously adapts to brightness [@hurvich_perception_1966], while the signals underlying the non-visual effects of light are independent from perception [@allen_exploiting_2018]. Retrospectively recalling the properties of a light source can further complicate such subjective evaluations. Moreover, measuring light properties alone does not yield any information about how individuals might behave differently regarding diverse light environments such as work, home or outdoors.

To date, little effort has been made to understand and capture these activities. Here, we present the development process of a novel self-reported inventory, the Light Exposure Behaviour Assessment (LEBA), for characterizing diverse light exposure-related behaviours. Notably, we do not claim to be estimating the personal light exposure with these questions. Instead, we aim to assess, in a scalable way, how people behave in relation to light, focusing on habitual patterns that could guide behavioural intervention points. 
...
It is important to note that, LEBA utilizes a five-point Likert-type response scale which is often susceptible to central tendency bias, where responses are biased towards the central value of the response scale [@aston2022central]. Without proper corrections of the response pattern, the interpretation of the scores could be erroneous. We recommend using the sensory precision suggested by @aston2022central method to correct the central tendency bias.

Lastly, this study is the lack of convergent validity evidence. LEBA being the first of its kind, lacks golden standard against which its convergent validity evidence  could be established. However, a recent study [@Siraji.2023] demonstrates the predictive validity of LEBA by successfully relating LEBA behaviour factors to chronotype, mood, sleep quality, and memory and concentration difficulties. The results of their study confirmed the very essence of LEBA-behaviour could led to different light exposure experiences that differentially influence health, wellness and performance. 


## Future directions

To our knowledge, the LEBA is the first inventory characterising light exposure-related behaviour in a scalable manner. Further evidence for the validity of the LEBA could be obtained by administering it conjointly with objective field measurements of light exposure (e.g. with portable light loggers/wearables, see literature review), smartphone readouts as well as subjective data in the form of 24-hour recalls. By this route, one  could study how the (subjectively measured) light exposure-related behavioural patterns translate into (objectively measured) received light exposure, (objectively measured) smartphone use, and how closely the retrospective questionnaire relates to daily reports of these behaviours.
